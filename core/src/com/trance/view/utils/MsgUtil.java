...
public class MsgUtil {
	...
	private final  String zh_player ="[{\"id\":-10001,\"msg\":\"登录key错误\"},{\"id\":-10003,\"msg\":\"注册时用户名已存在\"},{\"id\":-10004,\"msg\":\"注册时角色名已存在\"},{\"id\":-10005,\"msg\":\"重连被禁止\"},{\"id\":-10006,\"msg\":\"正在被攻击 等待4分钟\"},{\"id\":-10007,\"msg\":\"IP被封禁止登陆\"},{\"id\":-10008,\"msg\":\"购买体力次数上限\"},{\"id\":-10009,\"msg\":\"防沉迷状态错误\"},{\"id\":-10010,\"msg\":\"被防火墙加入黑名单\"},{\"id\": -10012,\"msg\":\"正在被攻击中(等侍4分钟)\"}]";
	...
	private final String en_player = "[{\"id\": -10001,\"msg\":\" login key error \"}, {\"id\": -10003,\"msg\":\"The user name already exists when registering \"}, {\"id\": -10004,\"msg\":\" the role name is already registered at the time of registration \"}, {\"id\": -10005,\"msg\":\" reconnection disabled \"},{ \"id\":-10006, \"msg\":\" being attacked wait 4 minutes \"}, {\"id\": -10007,\"msg\":\" IP is forbidden to land \"}, {\"id\": -10008,\"msg\":\" }, \",\"id\": -10009,\"msg\":\" anti-obfuscation status error \"}, {\"id\": -10010,\"msg\":\" blacklisted by the firewall \"},{\"id\": -10012,\"msg\":\" Being attacked (wait 4 minutes)\"} ]";
